...
When accessing the Web UI for the first time, login using the default username ("wayk-admin") and password ("wayk-admin"), after which you will be asked to create your own admin account with a new password.
